...
#     if varRow != 8:
#         keybutton=ttk.Button(root, text=button, command=command, width=5, )
#         keybutton.grid(row=varRow, column=varColumn)
#
#     if varRow == 8:
#         spacebutton=ttk.Button(root, text=button, command=command, width=30, )
#         spacebutton.grid(columnspan=40, row=varRow,column=varColumn)
#     varColumn += 1
